...
public partial class GameContext {
    ...
    public GameEntity SetLocalActionList(System.Collections.Generic.List<Sources.GamePlay.Common.Action> newActions, long newCheckedTick) {
        ...
        entity.AddLocalActionList(newActions, newCheckedTick);
        return entity;
    }

    public void ReplaceLocalActionList(System.Collections.Generic.List<Sources.GamePlay.Common.Action> newActions, long newCheckedTick) {
        var entity = localActionListEntity;
        if (entity == null) {
            entity = SetLocalActionList(newActions, newCheckedTick);
        } else {
            entity.ReplaceLocalActionList(newActions, newCheckedTick);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddLocalActionList(System.Collections.Generic.List<Sources.GamePlay.Common.Action> newActions, long newCheckedTick) {
        ...
        component.CheckedTick = newCheckedTick;
