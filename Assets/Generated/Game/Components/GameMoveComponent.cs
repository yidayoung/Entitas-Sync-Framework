...
public partial class GameEntity {
    ...
    public void AddMove(UnityEngine.Vector2 newTarget, long newMove_time, float newStart_direction) {
        var index = GameComponentsLookup.Move;
        var component = (MoveComponent)CreateComponent(index, typeof(MoveComponent));
        component.target = newTarget;
        component.move_time = newMove_time;
        component.start_direction = newStart_direction;
        AddComponent(index, component);
    }

    public void ReplaceMove(UnityEngine.Vector2 newTarget, long newMove_time, float newStart_direction) {
        var index = GameComponentsLookup.Move;
        var component = (MoveComponent)CreateComponent(index, typeof(MoveComponent));
        component.target = newTarget;
        component.move_time = newMove_time;
