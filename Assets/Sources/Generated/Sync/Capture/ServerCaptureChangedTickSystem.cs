...
public class ServerCaptureChangedTickSystem : ReactiveSystem<GameEntity>
{
	private readonly ServerNetworkSystem _server;
	public ServerCaptureChangedTickSystem (Contexts contexts, Services services) : base(contexts.game)
	{
	...
	protected override void Execute(List<GameEntity> entities) {
		...
		foreach (var e in entities) {
            ...
            e.tick.Serialize(_server.ChangedComponents);
