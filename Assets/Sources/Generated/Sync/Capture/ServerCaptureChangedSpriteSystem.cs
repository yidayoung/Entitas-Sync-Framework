...
public class ServerCaptureChangedSpriteSystem : ReactiveSystem<GameEntity>
{
	private readonly ServerNetworkSystem _server;
	public ServerCaptureChangedSpriteSystem (Contexts contexts, Services services) : base(contexts.game)
	{
	...
	protected override void Execute(List<GameEntity> entities) {
		...
		foreach (var e in entities) {
            ...
            e.sprite.Serialize(_server.ChangedComponents);
